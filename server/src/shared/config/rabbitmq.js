...
class RabbitMQConnection {
    constructor() {
        ...
        this.channel = null;
        this.isConnecting = false; // Flag to indicate if a connection attempt is in progress
    }
    ...
    async connect() {
        ...
        try {
            ...
            logger.info("RabbitMQ connection established successfully, queue created: ", config.rabbitmq.queue);
